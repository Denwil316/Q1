...
| »senales-9           | indicadores somáticos/atencionales (≥5/9)    | Glosario    | /docs/core/QEL_Manual_Operativo.md#sec-3-lamina         |
| »deltac-deltas       | variaciones de claridad/silencio             | Glosario    | /docs/core/QEL_Manual_Operativo.md#sec-3-lamina         |
| »h_k-clases          | tipología de dificultad (básica→obsidiana)   | Glosario    | /docs/core/QEL_Manual_Operativo.md#sec-3-lamina         |
