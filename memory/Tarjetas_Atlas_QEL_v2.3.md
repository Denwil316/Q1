...
# Tejera en Sur — Unificación Cuerpo/Ritmo (v2.3)
...
# Tarjetas Atlas QEL — v2.2 (con ingesta operativa)

> Integración con **MFH v1.2**, **Glosario v1.2**, **Diario v1.2** y **Lámina 𝒱**. Mantiene las tarjetas base e incorpora plantillas de cálculo y cierre.

---

## Lámina 𝒱 (extracto para Atlas)
- **Fórmula**: 𝒱(p,O,r,k) = clip₀¹(⟨b_p,m_O⟩ · χ_r · H_k · Π_gates)
- **Umbral**: **0.62** (junto con ΔC≥0 y **No‑Mentira**).
- **χ_r** (baseline): Oriente×1.10 · Norte×1.05 · Centro×1.00 · Occidente×0.95 · Sur×0.90
- **H_k**: básica 0.5 · poco común 0.8 · **rara 1.0** · metálica 1.2 · obsidiana 1.6
- **Rúbrica afinidades**: canónico 0.95 · directo 0.80 · indirecto 0.60 (±0.05)

## Plantilla “Ficha 𝒱 por Tarjeta”
```yaml
tarjeta: "<Kael|Vun|Ora|Zeh|Lun|Nai|Sün|Ida>"
triada: "<p·p·p>"           # e.g., "RA·SIL·A"
pesos: [0.40,0.30,0.30]     # suma 1.00
objeto: "<Prisma|Llave|Velo|...>"
rumbo: "<N|O|W|S|Centro>"
clase: "<básica|poco-común|rara|metálica|obsidiana>"
afinidades: [..,..,..]      # según rúbrica MFH
...
## Sugerencias de mapeo (orientativas, ajustar por FS)
- **Kael** → p: **RA·SIL·A** | O: **Prisma/Velo** | Uso: Transformar/Anclar
- **Vun** → p: **VOH·Ə·UM** | O: **Velo/Llave**   | Uso: Recordar/Despertar
- **Ora** → p: **A·UM·SIL**  | O: **Campana/Llave** | Uso: Anclar/Liberar
- **Zeh** → p: **Ə·SIL·EÍA** | O: **Espejo**       | Uso: Despertar/Transformar
- **Lun** → p: **A·Ə·VOH**   | O: **Portal/Velo**  | Uso: Recordar/Despertar
- **Nai** → p: **UM·Ə·SIL**  | O: **Llave/Velo**   | Uso: Recordar/Liberar
- **Sün** → p: **Ə·SIL·THON**| O: **Espejo/Latido**| Uso: Anclar/Despertar
- **Ida** → p: **A·RA·VOH**  | O: **Portal/Prisma**| Uso: Transformar/Anclar

> Ajuste fino ±0.05 en afinidades; si se usa **RA** en apertura, preferir mediación (prisma/velo).

## Buenas prácticas (Atlas)
- Mantén sesiones en **15–30′** (Esculpido v0.3).  
- Calcula **𝒱** solo si estás en **M1+**; en M0 basta ΔC/ΔS + No‑Mentira.  
- **Cierra siempre** con **SIL→UM→Ə** y registra en el **Diario v1.2**.  
- Promociona al **Árbol/VF** y **Listado R** **solo** si **Cristaliza**.

## Referencias
- MFH v1.2 — matrices 𝒱, χ_r, H_k y ejemplos.  
- Glosario v1.2 — Lámina 𝒱, definiciones y Modos.  
- Diario v1.2 — Ficha 𝒱, Plantilla FS y cierre.  
- Poema‑Enigma v1.0 — gramática operativa de VF.  
- Manual Sombras v1.1 — seguridad/ética y árbol de decisiones.
